                ...
                <div class="col-md-6 col-lg-5">
                    <div class="login-box bg-white box-shadow border-radius-10">
                        <div class="login-title">
                            <h5 class="text-center text-primary">EspaceShow Admin dashboard</h5>
                        </div>
                        <form action="{{route('admin.login')}}" method="POST">
                            ...
                            <div class="row pb-30">
                                ...
                                <div class="col-6">
                                    @if (Route::has('password.request'))
                                        <div class="forgot-password"><a href="{{ route('password.request') }}">Mot de
                                                passe oublié</a>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="input-group mb-0">
                                ...
                                {{--  <a class="btn btn-primary btn-lg btn-block" type="submit">Se connecter</a>  --}}
                                <button type="submit" class="btn btn-primary">
                                    {{ __('Login') }}
                                </button>
                            </div>
